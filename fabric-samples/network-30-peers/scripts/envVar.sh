...
setGlobals() {
  ...
  if [ $USING_ORG -eq 1 ]; then
    ...
    export CORE_PEER_ADDRESS=localhost:751
  elif [ $USING_ORG -eq 2 ]; then
    export CORE_PEER_LOCALMSPID="Org2MSP"
    export CORE_PEER_TLS_ROOTCERT_FILE=$PEER0_ORG2_CA
    export CORE_PEER_MSPCONFIGPATH=${PWD}/organizations/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp
    export CORE_PEER_ADDRESS=localhost:951
    ...
    export CORE_PEER_ADDRESS=localhost:1651
    ...
    export CORE_PEER_ADDRESS=localhost:1751
    ...
    export CORE_PEER_ADDRESS=localhost:1851
    ...
    export CORE_PEER_ADDRESS=localhost:1951
    ...
    export CORE_PEER_ADDRESS=localhost:2651
    ...
    export CORE_PEER_ADDRESS=localhost:2751
    ...
    export CORE_PEER_ADDRESS=localhost:2851
    ...
    export CORE_PEER_ADDRESS=localhost:2951
    ...
    export CORE_PEER_ADDRESS=localhost:3151
    ...
    export CORE_PEER_ADDRESS=localhost:3251
    ...
    export CORE_PEER_ADDRESS=localhost:3351
    ...
    export CORE_PEER_ADDRESS=localhost:3451
    ...
    export CORE_PEER_ADDRESS=localhost:3551
    ...
    export CORE_PEER_ADDRESS=localhost:3651
    ...
    export CORE_PEER_ADDRESS=localhost:3751
  else
